...
# Create a modern unified UI for the Users page
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left text-sm text-gray-600">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php 
                    $users = ($this->session->userdata('mr_sadmin') === "1") ? $allusers : $adminusers;
                    if ($users->num_rows() > 0):
...
$(document).ready(function() {
    ...
    $('.toggle-sub').change(function() {
        ...
        $.ajax({
            method: "post",
            url: "<?php echo base_url('manage-subscription'); ?>",
